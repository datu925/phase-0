...
//
//I had to look up the syntax to deleting a key-value pair from an object, since I forgot it. But otherwise I didn't have too hard of a time. The nested hash was interesting but didn't actually trip me up.
//
//How difficult was it to add and delete properties outside of the object itself?
//
//Not hard, since it's not that different from Ruby.
//
//What did you learn about manipulating objects in this challenge?
//
//It's so easy to have objects point to other objects. I think the trick is
//to make sure that you don't have objects changing and affecting other objects
